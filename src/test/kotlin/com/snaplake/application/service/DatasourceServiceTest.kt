...
import com.snaplake.application.port.inbound.RegisterDatasourceUseCase
import com.snaplake.application.port.inbound.UpdateDatasourceUseCase
...
class DatasourceServiceTest : DescribeSpec({
    ...
    val sut = DatasourceService(
        saveDatasourcePort, loadDatasourcePort, encryptionPort,
        dialectRegistry, snapshotSchedulerPort,
    )
    ...
    describe("update") {
        ...
        val existing = Datasource.reconstitute(
            id = existingId,
            name = "old-name",
            type = DatabaseType.POSTGRESQL,
            host = "localhost",
