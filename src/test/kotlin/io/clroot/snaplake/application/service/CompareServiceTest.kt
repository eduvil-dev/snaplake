...
import io.clroot.snaplake.adapter.outbound.query.DuckDbQueryEngine
import io.clroot.snaplake.adapter.outbound.storage.LocalStorageAdapter
import io.clroot.snaplake.application.port.inbound.*
import io.clroot.snaplake.application.port.outbound.LoadSnapshotPort
...
import io.clroot.snaplake.domain.model.SnapshotStatus
import io.clroot.snaplake.domain.model.SnapshotType
...
private fun createParquetFile(
    path: String,
    data: List<Triple<Int, String, Double>>,
) {
