package io.clroot.snaplake.domain.exception
...
class SystemAlreadyInitializedException :
    DomainException(
...
class SnapshotAlreadyRunningException(
...
class DatasourceConnectionFailedException(
    name: String,
    cause: String,
) : DomainException(
...
class StorageConnectionFailedException(
    cause: String,
) : DomainException(
...
class QueryExecutionFailedException(
    cause: String,
) : DomainException(
