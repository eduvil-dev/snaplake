...
import io.clroot.snaplake.application.port.outbound.ParquetWritePort
import io.clroot.snaplake.application.port.outbound.ParquetWriteResult
...
class DuckDbParquetWriter : ParquetWritePort {
    ...
    private fun appendValue(
        appender: org.duckdb.DuckDBAppender,
        rs: ResultSet,
        columnIndex: Int,
        sqlType: Int,
    ) {
